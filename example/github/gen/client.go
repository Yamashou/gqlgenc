...
const GetUserDocument = `query GetUser ($first: Int!) {
	viewer {
		id
		name
		createdAt
...
func (c *Client) GetUser(ctx context.Context, first int, httpRequestOptions ...client.HTTPRequestOption) (*GetUser, error) {
