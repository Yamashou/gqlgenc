...
func RenderTemplate(cfg *config.Config, fragments []*gotype.Fragment, operations []*gotype.Operation, operationResponses []*gotype.OperationResponse, structSources []*gotype.QueryType) error {
