...
func RenderTemplate(cfg *config.Config, fragments []*clientgenv2.Fragment, operations []*clientgenv2.Operation, operationResponses []*clientgenv2.OperationResponse) error {
